...
Understand general concepts behind their analysis > knowing which tool you should use right now, the field is evolving very fast 

"Orchestrating Single-Cell Analysis with Bioconductor" is an excellent starting point for many to read about the state of the art in R/Bioconductor + the companion book online
...
Ahead of us: clustering and dimensionality reduction, comparing cells based on their gene expression profiles
...
- Graph-based methods: cluster cells that are connected together (e.g., using nearest neighbours), e.g. `buildSNNGraph` or Seurat 
...
<i class="fab fa-github"></i> [`federicomarini/awesome-expression-browser`](https://github.com/federicomarini/awesome-expression-browser)
...
* <i class="fab fa-github"></i> [`iSEE`](https://github.com/iSEE) organization
  ...
  + <i class="fab fa-github"></i> [`iSEE/iSEEWorkshop2020`](https://github.com/iSEE/iSEEWorkshop2020) this workshop, expected to contain all information to reproduce the setup & analysis
